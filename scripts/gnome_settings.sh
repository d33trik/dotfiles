...
set_shortcuts() {
	...
	gsettings set org.gnome.settings-daemon.plugins.media-keys screensaver "['<Super>space']"
	gsettings set org.gnome.settings-daemon.plugins.media-keys shutdown "['<Super>dead_grave']"
